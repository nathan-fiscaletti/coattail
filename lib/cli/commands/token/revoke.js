...
const options = [
    ...
    },
    {
        name: 'config',
        alias: 'c',
        description: 'The path to the configuration file to use when revoking Tokens. Defaults to the config.yml file stored in the root of your Coattail installation.',
