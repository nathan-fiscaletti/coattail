...
const options = [
    ...
    },
    {
        name: 'config',
        alias: 'c',
        description: 'The path to the configuration file to use when validating the token. Defaults to the config.yml file stored in the root of your Coattail installation.',
...
module.exports = async cli => {
    ...
    // if (peer.token.getIssuer() == Token.getTokenIssuer()) {
