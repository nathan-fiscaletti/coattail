...
const options = [
    ...
    },
    {
        name: 'config',
        alias: 'c',
        description: 'The path to the configuration file to use when removing Tokens. Defaults to the config.yml file stored in the root of your Coattail installation.',
