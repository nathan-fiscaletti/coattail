...
class Server extends EventEmitter {
    ...
    listen() {
        ...
        this.server.listen(this.config.server.listen.port, this.config.server.listen.address, () => {
            this.emit('listening', this.config.server.listen.port, this.config.server.listen.address);
        });
    }
