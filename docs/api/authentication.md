...
Validation Tokens are a special type of Token that can be used to verify that a particular _Bearing Coattail Instance_ is authorized to be using the token it's bearing.